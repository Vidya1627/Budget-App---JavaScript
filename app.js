var budgetController = (function(){
    ...
    return {
        addItem: function(type, des, val){
            ...
            // var ids, index;
            // ids = data.allItems[type]; // ids is an obj 
        ...
        calculateBudget: function() {
            // calculate tot income and expenses
            calculateTotal('exp');
            calculateTotal('inc');
...
var UIController = (function(){
    ...
    return{
        getInput: function() {
            return{
                type: document.querySelector(DOMstrings.inputType).value, // gives inc or exp
        ...
        clearFields: function(){
           ...
           fields = document.querySelectorAll(DOMstrings.inputDescription + ','
            ...
            fieldsArr.forEach(function(current, index, arrar) {
                current.value = '';
            });
        ...
        displayPercentages: function(percentages) {
            var field;
            field = document.querySelectorAll(DOMstrings.expensesPercLabel); // field is a node list
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var updatePercentages = function() {
        ...
        // 3. update the UI with new perc
        // console.log('updatePercentages method after cal percentage:  ');
